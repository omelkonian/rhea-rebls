...
the Robot Operating System (ROS). Moreover, it does assume distributed execution
...
Uses RxJava~\site{http://github.com/ReactiveX/RxJava}, an established and well-maintained library for
...
\section{Distributed Execution} \label{sec:distributed}
